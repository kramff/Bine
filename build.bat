...
echo go to the Isomorphic folder and copy those new files over
cd ..\Isomorphic
xcopy * ..\..\kramff.github.io\Isomorphic\
...
echo go to the Isomorphic server folder and copy those files in
cd ..\Isomorphic
xcopy * ..\..\bine-online\Isomorphic\
